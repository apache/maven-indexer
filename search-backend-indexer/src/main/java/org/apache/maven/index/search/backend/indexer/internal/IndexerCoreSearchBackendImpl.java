...
public class IndexerCoreSearchBackendImpl extends SearchBackendSupport implements IndexerCoreSearchBackend
{
    ...
    private Query toQuery( HashSet<Field> searchedFields, org.apache.maven.index.search.request.Query query )
    {
        if ( query instanceof org.apache.maven.index.search.request.BooleanQuery.And )
        {
            org.apache.maven.index.search.request.BooleanQuery bq =
                    (org.apache.maven.index.search.request.BooleanQuery) query;
        ...
        else if ( query instanceof org.apache.maven.index.search.request.FieldQuery )
        {
            org.apache.maven.index.search.request.FieldQuery fq =
                    (org.apache.maven.index.search.request.FieldQuery) query;
