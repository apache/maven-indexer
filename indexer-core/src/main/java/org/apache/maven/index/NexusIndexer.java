 ...
 * These indexers could be created
 * using the CLI command line tool or {@link org.apache.maven.index.packer.IndexPacker} API.
 * <p>
...
public interface NexusIndexer
{
    ...
    @Deprecated
    IndexingContext addMergedIndexingContext( String id, String repositoryId, File repository, Directory indexDirectory,
                                              boolean searchable, Collection<IndexingContext> contexts )
            throws IOException;
