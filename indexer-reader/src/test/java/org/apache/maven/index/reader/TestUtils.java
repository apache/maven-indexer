...
public final class TestUtils
{
    ...
    public static Function<Record, Map<String, String>> compactFunction = new Function<Record, Map<String, String>>()
    {
    ...
    public static Function<Map<String, String>, Record> expandFunction = new Function<Map<String, String>, Record>()
    {
