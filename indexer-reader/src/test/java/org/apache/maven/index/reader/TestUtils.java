...
public final class TestUtils
{
    ...
    public static Function<Record, Map<String, String>> compactFunction = RECORD_COMPACTOR;

    public static Function<Map<String, String>, Record> expandFunction = RECORD_EXPANDER;
