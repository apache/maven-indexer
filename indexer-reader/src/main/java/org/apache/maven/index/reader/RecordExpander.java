...
public class RecordExpander
{
     ...
     */
    private static void putIfNotNull( final Map<String, String> source, final String sourceName, final Record target,
     ...
     */
    private static void putIfNotNullTS( final Map<String, String> source, final String sourceName, final Record target,
                                        final EntryKey targetName )
    {
        String value = source.get( sourceName );
        if ( value != null && value.trim().length() != 0 )
     ...
     */
    private static void putIfNotNullAsStringArray( final Map<String, String> source, final String sourceName,
