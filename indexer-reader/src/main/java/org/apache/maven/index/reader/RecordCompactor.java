 ...
 * @since 5.1.2
 */
public class RecordCompactor implements Function<Record, Map<String, String>> {
    /**
    ...
    private static String compactUinfo(final Record record) {
        ...
        StringBuilder sb = new StringBuilder()
                .append(record.getString(Record.GROUP_ID))
                .append(FIELD_SEPARATOR)
                .append(record.getString(Record.ARTIFACT_ID))
                .append(FIELD_SEPARATOR)
                .append(record.getString(Record.VERSION))
                .append(FIELD_SEPARATOR)
    ...
    private static void putIfNotNullAsStringArray(
            final String[] source, final Map<String, String> target, final String targetName) {
